    ...
    <header class="navbar navbar-expand-md navbar-light sticky-top d-print-none">
      <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
          <a href=".">
            <img src="{{ asset('img/logo.svg') }}" alt="Tabler" class="navbar-brand-image" width="110" height="32">
          </a>
        </h1>
        <div class="navbar-nav order-md-last flex-row">
          ...
          <div class="d-none d-md-flex">
            <a href="?theme=dark" class="nav-link hide-theme-dark me-3 px-0" data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="Enable dark mode"
            ...
            <a href="?theme=light" class="nav-link hide-theme-light me-3 px-0" data-bs-toggle="tooltip" data-bs-placement="bottom"
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
              <span class="avatar avatar-sm" style="background-image: url(./img/realist.png)"></span>
              <div class="d-none d-xl-block ps-2">
                <div>Lotrando</div>
                <div class="small text-muted mt-1">Gentoo Guru</div>
              </div>
            </a>
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      ...
                      <div class="dropend">
                        <a class="dropdown-item dropdown-toggle" href="#sidebar-cards" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                    ...
                    <div class="dropdown-menu-column">
                      ...
                      <div class="dropend">
                        <a class="dropdown-item dropdown-toggle" href="#sidebar-error" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                          role="button" aria-expanded="false">
